...
that attempts to automatically _"do the right thing"_, rather than
...
- [QEMU](https://www.qemu.org/) (_6.0.0 or newer_) **with GTK, SDL,
...
If you see _"Your device or computer could not be verified"_ when you
try to login to the App Store, make sure that your wired ethernet device
is `en0`. Use `ifconfig` in a terminal to verify this.

If the wired ethernet device is not `en0`, then then go to _System
Preferences_ -\> _Network_, delete all the network devices and apply the
